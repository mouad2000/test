	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $onelatest => $onedata) {
      	# code...
			...
			<a href="single.php?id='.$onedata['id'].'" class="btn btn-primary read-m">En savoir plus</a>
			</div>';
		}
	}
      	...
      	# code...
			echo '<div class="col-md-6 card">
							...
							<div class="card-body">
								...
								<a href="single.php?id='.$cdata['id'].'" class="btn btn-primary read-m">En savoir plus</a>
							</div>
						</div>';
		}
	}
