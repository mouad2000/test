			...
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="index.php">
						<img src="./images/log.ico" with="200px" height="70px"/>Didaskayn</a>
				</div>
				...
				<div class="col-md-4 log-icons text-right">
					...
					<ul class="social_list1 mt-3">
						...
						<li>
							<a href="https://web.facebook.com/didakayn/?_rdc=1&_rdr" class="facebook1 mx-2" >
						...
						<li>
							<a href="https://lu.linkedin.com/company/didaskayn" class="dribble3 mx-2">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<form action="search.php" method="post" class="form-inline my-2 my-lg-0 header-search" name="form">
								<input class="form-control mr-sm-2" type="search" placeholder="Recherchez ici..." required="yes" type="text" name="search[keyword]">
